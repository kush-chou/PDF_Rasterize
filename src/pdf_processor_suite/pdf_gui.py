...
class ConfigManager:
    ...
    def _load_defaults(self):
        return {"gs_path": "gs", "magick_path": "magick", "create_parent_splits": True}
...
def run_split_and_rasterize_wrapper(
    ...
    args = SimpleNamespace(
        ...
        create_parent_splits=create_parent_splits,
        gs_path=gs_path,
...
class MainWindow(QMainWindow):
    ...
    def start_split_process(self):
        ...
        config_manager.set(
            "create_parent_splits", self.create_parent_splits_chk.isChecked()
        )
        config_manager.set(
            "max_split_level",
        ...
        self._start_worker(
            ...
            self.create_parent_splits_chk.isChecked(),
